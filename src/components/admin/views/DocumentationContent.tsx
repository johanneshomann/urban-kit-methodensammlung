      ...
      },
      {
        ...
        a: {
          ...
          en: [
            ...
            'Per sponsor, pick a logo from the media library (SVG or landscape PNG with transparent background works best), enter the name (appears as a tooltip and for screen readers – not visibly next to the logo) and optionally the website address incl. https://. Choose the size “Large” for combined funding blocks with small lettering. “Show on” controls whether a logo appears in the footer, on the About page, or both (e.g. combined block footer-only, individual logos About-only).',
