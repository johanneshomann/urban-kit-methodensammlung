    ...
    <div ref={containerRef} className="fixed bottom-6 left-6 z-40">
      {open && (
        <div
          ...
          aria-label={t('title')}
          tabIndex={-1}
          className="popover-in absolute bottom-full left-0 mb-3 w-72 rounded-xl border p-4 outline-none"
          style={{
            background: 'var(--method-white)',
            borderColor: 'var(--method-light)',
            boxShadow: '0 10px 25px rgba(0,0,0,0.12), 0 4px 10px rgba(0,0,0,0.08)',
            color: 'var(--method-ink)',
          }}
        >
          <div className="mb-3 flex items-center justify-between">
            <h2 className="text-text font-bold" style={{ color: 'var(--method-ink-accent)' }}>
              {t('title')}
            </h2>
            <button
              type="button"
          ...
          <div className="mb-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              <button
                ...
                style={{ borderColor: 'var(--method-light)' }}
              >
      ...
      <button
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-2xl shadow-lg transition-transform hover:scale-105"
